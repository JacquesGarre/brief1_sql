...
SELECT PRODUCT_FAMILY, PRODUCT_TYPE, ITEM_PRICE
FROM vendeur1 GROUP BY ITEM_PRICE, PRODUCT_FAMILY, PRODUCT_TYPE 
ORDER BY PRODUCT_FAMILY, PRODUCT_TYPE, ITEM_PRICE;
...
SELECT PRODUCT_FAMILY, PRODUCT_TYPE, ITEM_PRICE
FROM vendeur2 GROUP BY ITEM_PRICE, PRODUCT_FAMILY, PRODUCT_TYPE 
ORDER BY PRODUCT_FAMILY, PRODUCT_TYPE, ITEM_PRICE;
